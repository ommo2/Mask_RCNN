...
#COCO_MODEL_PATH = os.path.join(ROOT_DIR, os.path.join("logs_with_clip","polyp20210810T1947","mask_rcnn_polyp_0023.h5"))
...
# 基础设置
dataset_root_path = "./"
img_folder = dataset_root_path + "../data/600_50_with_clip/TA_SSA_HP_600_data_split/train"
mask_folder = dataset_root_path + "../data/600_50_with_clip/TA_SSA_HP_600_split_mask/train"
yaml_folder = dataset_root_path + "../data/600_50_with_clip/TA_SSA_HP_600_split_yaml/train"
...
val_img_folder = dataset_root_path + "../data/600_50_with_clip/TA_SSA_HP_600_data_split/validation"
val_mask_folder = dataset_root_path + "../data/600_50_with_clip/TA_SSA_HP_600_split_mask/validation"
yaml_folder = dataset_root_path + "../data/600_50_with_clip/TA_SSA_HP_600_split_yaml/validation"
